...
describe 'Visitante consulta disponibilidade de um quarto durante um período' do
  ...
  it 'e a data de entrada é posterior à data de saída' do
    luiza = User.create!(name: 'Luiza Souza', email: 'luiza@gmail.com', cpf: '38573169346', password: 'password', role: 'host')
    g = Guesthouse.create!(corporate_name: 'Pousada Ouro Branco Ltda', brand_name: 'Pousada Ouro Branco', registration_number:'45789800129', 
                            phone_number: '11998756542', email: 'pousadaourobranco@gmail.com', address: 'Rua Santos Dumont, 65', 
                            neighborhood: 'Centro', state: 'Rio de Janeiro', city: 'Rio de Janeiro', postal_code: '27120-100', 
    ...
    click_on 'Quarto Padrão'
    click_on 'Reservar'
    fill_in 'Data de entrada', with: '15/12/2023'
    fill_in 'Data de saída', with: '12/12/2023'
    fill_in 'Quantidade de hóspedes', with: '2'
    click_on 'Consultar'

    #Assert
    expect(current_path).to eq check_availability_room_bookings_path(r.id)
    expect(page).to have_content 'Data de entrada deve ser anterior à data de saída'
  end

  it 'e a quantidade de hóspedes da consulta é maior que a quantidade de hóspedes permitida do quarto' do
    luiza = User.create!(name: 'Luiza Souza', email: 'luiza@gmail.com', cpf: '38573169346', password: 'password', role: 'host')
    g = Guesthouse.create!(corporate_name: 'Pousada Ouro Branco Ltda', brand_name: 'Pousada Ouro Branco', registration_number:'45789800129', 
                            phone_number: '11998756542', email: 'pousadaourobranco@gmail.com', address: 'Rua Santos Dumont, 65', 
                            neighborhood: 'Centro', state: 'Rio de Janeiro', city: 'Rio de Janeiro', postal_code: '27120-100', 
    ...
    #Assert
    expect(current_path).to eq check_availability_room_bookings_path(r.id)
    expect(page).to have_content 'Quantidade de hóspedes ultrapassa o permitido para o quarto.'
  end
end