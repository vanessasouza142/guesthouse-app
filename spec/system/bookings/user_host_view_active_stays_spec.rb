...
describe 'Usuário anfitrião vê estadias ativas da sua pousada' do
  ...
  it 'ao acessar menu Estadias Ativas' do
    ...
    juliana = User.create!(name: 'Juliana Souza', email: 'juliana@gmail.com', cpf: '02163471578', password: 'password', role: 'guest')
  ...
  it 'e não vê reservas com status:pendente' do
    #Arrange
    luiza = User.create!(name: 'Luiza Souza', email: 'luiza@gmail.com', cpf: '38573169346', password: 'password', role: 'host')
    g = Guesthouse.create!(corporate_name: 'Pousada Ouro Branco Ltda', brand_name: 'Pousada Ouro Branco', registration_number:'45789800129', 
                            phone_number: '11998756542', email: 'pousadaourobranco@gmail.com', address: 'Rua Santos Dumont, 65', 
    ...
    within('tbody') do
      ...
      expect(page).not_to have_content "#{I18n.l(5.days.ago, format: "%d/%m/%Y")}"
      expect(page).not_to have_content "#{I18n.l(15.days.from_now, format: "%d/%m/%Y")}"
    end
  end
