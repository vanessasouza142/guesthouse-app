...
describe 'Usuário anfitrião registra um quarto' do
  ...
  it 'e não é o dono' do
    ...
    #Act
    login_as(mariana)
    post(guesthouse_rooms_path(g1.id), params: { room: { name: 'Quarto Girassol', description: 'Quarto amplo com vista para o mar', 
                                                        area: '10', max_guest: '4', default_price: '210,00', bathroom: 'sim', 
                                                        balcony: 'sim', air_conditioner: 'sim', tv: 'sim', wardrobe: 'sim', safe: 'não', 
                                                        accessible: 'sim'}})
